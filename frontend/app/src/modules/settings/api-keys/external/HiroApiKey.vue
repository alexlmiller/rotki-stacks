...
import { hiroLink } from '@shared/external-links';
...
<template>
  <ServiceKeyCard
    :name="name"
    :key-set="!!key"
    data-cy="hiro-api-keys"
    :title="t('external_services.hiro.title')"
    :subtitle="t('external_services.hiro.description')"
    :image-src="getPublicServiceImagePath('hiro.svg')"
  ...
  >
    ...
    <ServiceKey
      ...
      :hint="t('external_services.hiro.hint')"
      :loading="loading"
      :status="status"
      @save="save($event)"
    >
