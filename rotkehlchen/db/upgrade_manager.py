...
from rotkehlchen.db.upgrades.v52_v53 import upgrade_v52_to_v53
...
UPGRADES_LIST = [
    ...
    UpgradeRecord(from_version=52, function=upgrade_v52_to_v53),
    UpgradeRecord(from_version=53, function=upgrade_v53_to_v54),
]
