...
T_Transaction = TypeVar('T_Transaction', bound='SolanaTransaction | EvmTransaction | StacksTransaction')  # noqa: E501
...
T_TxNotDecodedFilterQuery = TypeVar(
    ...
    bound=EvmTransactionsNotDecodedFilterQuery | SolanaTransactionsNotDecodedFilterQuery | StacksTransactionsNotDecodedFilterQuery,  # noqa: E501
)
